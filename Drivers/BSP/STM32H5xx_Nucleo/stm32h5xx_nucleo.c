...
/** @defgroup STM32H5XX_NUCLEO_LOW_LEVEL STM32H5XX_NUCLEO LOW LEVEL
...
/** @defgroup STM32H5XX_NUCLEO_LOW_LEVEL_Private_Defines STM32H5XX_NUCLEO LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STM32H5XX_NUCLEO_LOW_LEVEL_FunctionPrototypes STM32H5XX_NUCLEO LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STM32H5XX_NUCLEO_LOW_LEVEL_Private_Variables STM32H5XX_NUCLEO LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__STM32H5XX_NUCLEO_BSP_VERSION;
}
